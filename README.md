...
<div class="row" style="padding: 5%;">
  <div class="col-md-6 p-6" style="padding: 5%;"> <img style="width: 100%; height: 100%;" src="depilacijavosak.PNG" alt=""> </div>
  <div class="col-md-6 "><h5 style="padding-top: 10%; padding-bottom: 5%; padding-left: 5%; padding-right: 5%; text-align: center; font-family: cursive;">HLADNA DEPILACIJA</h5>
    <p style="font-family: cursive">Depilacija hladnim voskom je veoma brz i efikasan postupak. To je tretman koji daje trajnije rezultate. Redovnom primenom ovog tretmana, dlaka se znatno proredjuje, a koren sve više slabi. Koža se ni na koji način ne može oštetiti i najčešće se preporučuje osobama osetljivim na visoke temperature. <br> Devojke zakažite Vaš termin na vreme. </p> 
  </div>
 
</div>

<div class="div" style="text-align: center; padding: 5%; font-family: cursive;">
  <p style="padding-left: 20%; font-family: cursive;">  Usluge depilacije koje možete dobiti u našem salonu su sledeće: </BR> <br>  <i style="font-size:24px" class="fa">&#xf14a;</i> Depilacija celih nogu toplim voskom<br> <i style="font-size:24px" class="fa">&#xf14a;</i> Depilacija celih ruku hladnim voskom <br>  <i style="font-size:24px" class="fa">&#xf14a;</i> Brazilska depilacija <br> <i style="font-size:24px" class="fa">&#xf14a;</i> Depilacija pola nogu<br>  <i style="font-size:24px" class="fa">&#xf14a;</i> Depilacija nausnica <br>   </p>
</p>
</div>
...
<div class="col-md-12 " style="padding: left 20px; font-family: cursive;">
  <div class="row" style="padding-left: 80px;">
  <img style="width: 250px; height: 200px; border: 20px solid transparent;" src="uljedepilacija.PNG" alt="">

  <img style="width: 230px; height: 200px; border: 20px solid transparent;" src="svedepilacije.PNG" alt="">
  <img style="width: 250px; height: 200px; border: 20px solid transparent;" src="vosakDepilacija.PNG" alt="">
  <img style="width: 250px; height: 200px; border: 20px solid transparent;" src="depilacija.jfif" alt="">
       ...
       <!-- Footer -->
       <footer class="page-footer font-small unique-color-dark " style="font-family: cursive;">

        <div style="background-color:rgb(189, 160, 160)">
          <div class="container ">
            ...
            <div class="row py-4 d-flex align-items-center">
              ...
              <div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0">
                <h6 style="font-style: italic; font-size: 30px;" class="mb-0">NADLEN</h6>
              </div>
              <!-- Grid column -->
